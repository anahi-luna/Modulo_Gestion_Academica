// Mock de Certificados. Mismo patrón que el resto de los mocks del proyecto:
// simula el delay de red y devuelve { status, data, message }.
// Cuando exista el microservicio real, solo hay que reescribir estas
// funciones para que hagan fetch a `${API_URL}/certificados...`.

const delay = (ms = 300) =>
  new Promise((resolve) => setTimeout(resolve, ms));

// Tipos de certificado que puede emitir el instituto
...
// "Base de datos" en memoria. id_legajo e id_comision hacen referencia
// a los mismos ids que ya usan legajosMock y comisionesMock.
let CERTIFICADOS = [
  {
    idCertificado: 1,
...
// Certificados de UN alumno (vista Alumno)
...
// Todos los certificados (vista Admin)
...
// Emite y firma un certificado (o re-emite uno pendiente si viene idCertificado)
...
// Revoca un certificado ya emitido
