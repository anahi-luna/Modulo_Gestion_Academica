// Vista del Alumno: consulta de sus propias calificaciones.
// Solo lectura (RBAC: Alumno = R propio sobre Calificaciones).

import { useEffect, useState } from "react";
import { obtenerMisCalificaciones } from "../Services/calificacionesService";
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <main className="max-w-4xl mx-auto px-4 py-6">
        <h1 className="text-2xl font-bold text-gray-800">Mis calificaciones</h1>
        <p className="text-sm text-gray-500 mb-6">
          Notas obtenidas en cada comisión en la que estás inscripto.
        </p>
