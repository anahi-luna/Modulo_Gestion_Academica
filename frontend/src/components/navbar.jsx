...
export default function Navbar({usuario, setUsuario}) {
    ...
    `px-3 py-2 rounded-md text-sm font-medium transition-colors
     ${isActive
       ? "bg-red-600 text-white"                          // link activo
       : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700" // inactivo
     }`;
    ...
    return(
        <Disclosure
          as="nav"
          className="bg-red-800 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10"
        >
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                        <NavLink to="/"          className={linkClass} end>Inscripcion</NavLink>
