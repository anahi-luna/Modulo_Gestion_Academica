                        ...
                        {items.map((ins) => (
                            <div key={ins.id} className="p-4">
                                ...
                                <div className="flex gap-2">
                                    {hasPermission("inscripcion.inscripciones.actualizar") && (
                                            !["Finalizado", "Finalizada", "Cancelada", "Rechazada"].includes(ins.estado ?? "") && (
...
function FilaInscripcion({ inscripcion, onValidar, onEliminar }) {
  ...
  const puedeEditar = !["Finalizado", "Finalizada", "Cancelada", "Rechazada"].includes(estado);
  const {hasPermission} = useAuth();
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <td className="px-4 py-3">
        <div className="flex gap-2 justify-end">
          {puedeEditar && hasPermission("inscripcion.inscripciones.actualizar") && (
            <button
