...
export default function SeccionTabla({
    ...
    // Estados que no permiten modificar la inscripción.
    // Los nombres vienen del catálogo; no usamos IDs hardcodeados.
    ...
    return (
        <div className="bg-white rounded-xl shadow mb-6 overflow-hidden">
            ...
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <span
                    className={`text-xs px-2 py-0.5 rounded-full font-bold text-white ${colorBadge}`}
                >
                    {items.length}
                </span>
            </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {editable &&
                                            hasPermission(
                                                "inscripcion.inscripciones.actualizar"
                                            ) && (
                                                <button
                                                    onClick={() =>
                                        ...
                                        {hasPermission(
                                            "inscripcion.inscripciones.eliminar"
                                        ) && (
                                            <button
                                                onClick={() =>
