...
def get_lista_de_calificaciones():
    ...
    id_evaluacion = request.args.get(
        "id_evaluacion",
        type=int
    )
    ...
    resultado = calificaciones_schema.dump(
        calificaciones
    )
...
def get_calificacion(id_calificacion):
    ...
    resultado = calificacion_schema.dump(
        calificacion
    )
...
def agregar_calificaciones():
    ...
    try:
        ...
        datos = calificacion_request_schema.load(
            request.get_json()
        )

        nuevas = crear_calificaciones(
            datos
        )
...
def actualizar_calificacion(id_calificacion):
    ...
    try:
        ...
        datos = modificar_calificacion_schema.load(
            request.get_json()
        )

        calificacion = modificar_calificacion(
            id_calificacion,
            datos
        )
        ...
        return success_response(
            data=resultado,
            message=f"Calificación {id_calificacion} actualizada."
        )
...
def eliminar_calificacion_controller(id_calificacion):
    ...
    try:
        ...
        eliminado = eliminar_calificacion(
            id_calificacion
        )
        ...
        return success_response(
            message=f"Calificación {id_calificacion} eliminada."
        )
